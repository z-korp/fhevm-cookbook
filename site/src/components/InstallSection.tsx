...
export default function InstallSection() {
  return (
    <section id="install" className="scroll-mt-24 border-b border-border py-16 sm:py-20 lg:py-24">
      <div className="grid gap-10 lg:grid-cols-[470px_1fr] lg:items-start lg:gap-16">
        <div className="max-w-[470px]">
          ...
          <p className="mt-5 text-[16px] leading-[1.6] text-secondary sm:mt-6">
            Uses the open{" "}
            <a
              href={SKILLS_SH_URL}
              target="_blank"
            ...
            CLI. Most teams should start with the full install. Single-skill commands are available
            on each catalog card.
          </p>
        </div>

        <div className="flex flex-col gap-3">
          <div className="relative rounded-2xl border border-foreground bg-foreground p-5 sm:p-7">
            <div className="relative z-10">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <code className="min-w-0 flex-1 break-all font-mono text-[13px] leading-[1.5] text-on-dark sm:text-[14px]">
                  {FULL_PACK_COMMAND}
                </code>
          ...
          <div className="rounded-2xl border border-border bg-surface p-5 sm:p-7">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <code className="min-w-0 flex-1 break-all font-mono text-[13px] leading-[1.5] text-foreground sm:text-[14px]">
                {LIST_SKILLS_COMMAND}
              </code>
